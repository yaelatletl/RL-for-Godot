...
func _handshake():
	print_debug("performing handshake")
	...
	if major_version != MAJOR_VERSION:
		print_debug("WARNING: major verison mismatch ", major_version, " ", MAJOR_VERSION)  
	if minor_version != MINOR_VERSION:
		print_debug("WARNING: major verison mismatch ", minor_version, " ", MINOR_VERSION)
